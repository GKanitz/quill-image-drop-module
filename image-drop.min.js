(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ImageDrop"] = factory();
	else
		root["ImageDrop"] = factory();
})(this, function() {
...
var apply = __webpack_require__(16),
    ...
    customDefaultsMerge = __webpack_require__(59),
    mergeWith = __webpack_require__(97);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__DefaultOptions__ = __webpack_require__(32);
   ...
   */
		...
		value: function insert(dataUrl) {
			...
			if (this.options.callback !== null && this.options.callback !== undefined) {
				this.options.callback(dataUrl, function (url) {
					_this2.quill.insertEmbed(index, 'image', url, 'user');
				});
			} else {
